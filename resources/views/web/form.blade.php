    ...
    <div class="stepwizard">
        <div class="stepwizard-row setup-panel">
            ...
            <div class="stepwizard-step">
                ...
                <p class="wizard-btn-title">Patient Syndromes</p>
            </div>
            <div class="stepwizard-step">
                <a href="#step-3" type="button" class="btn inactive btn-circle" disabled="disabled">3</a>
                <p class="wizard-btn-title">Patient Medicines</p>
            </div>
        </div>
    </div>
    <form role="form">
        ...
        <div class="row setup-content" id="step-2">
            <div class="col-xs-12 col-lg-12">
                <h3 class="wizard-section-title">Patient Syndromes</h3>
            </div>
        ...
        <div class="row setup-content" id="step-3">
            <div class="col-xs-12 col-lg-12">
                <h3 class="wizard-section-title">Patient Medicines</h3>
            </div>
            ...
            <div class="col-xs-12 col-lg-12">
                <button class="btn lastBtn" type="submit">Next</button>
            </div>
        </div>
    </form>
  </div>
