            ...
            <div class="col-xs-12 col-lg-12">
              ...
              @if(isset($report))
                ...
                @if($emergency_issue == 0)
                  <p>NB: You don't have any emergency syndromes. Stay home and take care of your health.</p>
                @else
                  <p>NB: You have emergency syndromes. You might be need health support. Please contact with doctor or call to 999.</p>
                @endif
