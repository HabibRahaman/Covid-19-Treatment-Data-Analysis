            ...
            <ul id="slide-out" class="sidenav">
                ...
                <li>
                    <ul class="collapsible">
                        ...
                        @can('Conditions')
                        <li>
                            <a href="{{ route('admin.condition.index') }}" class="collapsible-header"><i class="material-icons">verified_user</i><span class="hide-menu"> Medical Conditions </span></a>
                        </li>
                        @endcan

                        @can('HealthCares')
                        <li>
                            <a href="{{ route('admin.healthcare.index') }}" class="collapsible-header"><i class="material-icons">verified_user</i><span class="hide-menu"> Health Care </span></a>
                        </li>
                        @endcan

                        @can('Blogs')
                        <li>
                            <a href="{{ route('admin.blog.index') }}" class="collapsible-header"><i class="material-icons">verified_user</i><span class="hide-menu"> Info Blogs </span></a>
                        </li>
                        @endcan
