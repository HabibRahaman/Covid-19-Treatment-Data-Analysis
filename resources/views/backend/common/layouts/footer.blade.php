            ...
            <footer class="center-align m-b-30 m-t-20">
                © 2014 - <?php echo date('Y') ?> All Rights Reserved. <a href="https://arcturustechnology.com/" target="_blank">Arcturus Technology</a> No part of this site may be reproduced without our written permission.
            </footer>
        </div>
        <!-- ============================================================== -->
