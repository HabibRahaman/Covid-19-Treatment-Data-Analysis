                            ...
                            <table id="file_export" class="table table-striped display" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <a class="waves-effect waves-light btn btn-small blue modal-trigger" href="#viewitem-{{ $symptom->id }}" data-toggle="tooltip" data-placement="top" title="View">
                                                ...
                                                <div class="card-content">
                                                    ...
                                                    <form  action="{{ route($route.'update', [$symptom->id]) }}" method="post" novalidate>
                                                        ...
                                                        <div class="row">
                                                            <div class="col s12">
                                                                <label>
                                                                    <input type="checkbox" name="show" class="filled-in" value="1" @if($symptom->show == 1) checked="checked" @endif/>
                                                                    <span>Show</span>
                                                                </label>
                                                            </div>
                                                        </div>  
